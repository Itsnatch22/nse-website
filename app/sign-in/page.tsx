...
const SignInPage = () => {
  ...
  const handleSubmit = (e: { preventDefault: () => void; }) => {
    e.preventDefault();
    // Handle sign in - mock for now
    console.log('Sign in attempt:', { email, password });
    alert('Sign in functionality will be connected to the backend.');
  };

  return (
    <div className="min-h-screen bg-linear-to-br from-slate-50 via-white to-emerald-50/30 flex items-center justify-center px-4 py-12">
        ...
        <Card className="border-slate-200 shadow-xl">
          ...
          <CardContent>
            ...
            <p className="mt-6 text-center text-sm text-slate-500">
              ...
              <Link href="/get-started" className="text-emerald-600 hover:text-emerald-700 font-medium">
                Start free trial
              </Link>
            </p>
          </CardContent>
